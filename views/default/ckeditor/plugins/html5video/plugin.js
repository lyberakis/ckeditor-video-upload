        ...
        editor.widgets.add( 'html5video', {
            ...
            data: function() {
                ...
                if ( this.data.src ) {
                    ...
                    // this.element.getChild( 0 ).setAttribute( 'type', 'video/mp4' );
                    videoElement.append('source');
                    videoElement.getChild(0).setAttribute( 'src', this.data.src );
                    videoElement.getChild(0).setAttribute('type', 'video/mp4');
